<template>
  <el-card>
    ...
    >
      ...
      <el-table-column prop="uid" label="用户详情" >
        <template slot-scope="scope">
            <el-button icon="el-icon-edit-outline" type="text" @click="onClickDetailButton(scope.row.uid)">编辑</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 尾部 分页栏 -->
...
export default {
  ...
  data () {
    return {
      ...
      // 信息:id, certification_id, name, password, state
      tableData: []
    }
  }
}
